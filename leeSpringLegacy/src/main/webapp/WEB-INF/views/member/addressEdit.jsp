...
<form id="addressEditForm" name="addressEditForm">
	...
	<div id="addressEditDiv">
		...
		<input type="hidden" id="addr_number" name="addr_number" value=${param.addnum}> <label for="address"
			style="color: gray">배송지명</label><br /> <input type="text"
			id="addr_name" name="addr_name"
			style="width: 100%; border: 0px; border-bottom: 1px solid gray">
		<p></p>

		<label for="name" style="color: gray">이름</label><br /> <input
			type="text" id="user_name" name="user_name" value=""
			style="width: 100%; border: 0px; border-bottom: 1px solid gray" />
		...
		<div id="postDiv">
			<div id="post1">
				<label for="post" style="color: gray">우편번호</label><br /> <input
					type="text" id="zipcode" name="zipcode" value="" readonly
					style="width: 100%; border: 0px; border-bottom: 1px solid gray" />
			</div>
			<div id="post2">
		...
		<label for="address" style="color: gray">주소1(지번/도로명)</label><br /> <input
			type="text" id="addr1" name="addr1" value="" readonly
			style="width: 100%; border: 0px; border-bottom: 1px solid gray" />
		<p></p>
