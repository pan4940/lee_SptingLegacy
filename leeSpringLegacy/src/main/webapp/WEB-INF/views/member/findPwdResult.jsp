...
<div id="findPwdResultDiv" class="col-12 col-lg-6">
	...
	<ul>
		...
		<li id="radiofind"><label for="searchOption" style="color: gray">${memOption}</label><br />
			...
			<input type="hidden" value="${memKeyword}" id="memKeyword"></li>

	</ul>
	<br> 
	<input id="rePwdBtn" type="button" name="pwdbtn2"
		style="font-size: 9pt" value="임시비밀번호 전송" ; /> 
	<input id="cancel" type="button" name="cancelbtn" style="font-size: 9pt" 
	value="로그인" onclick="location.href = 'loginForm' " />
</div>
